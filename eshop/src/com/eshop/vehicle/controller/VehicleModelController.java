...
public class VehicleModelController {
	...
	public String addVehicleModel(@Valid @ModelAttribute("vehicleModel") VehicleModelForm vehicleModelForm, BindingResult bindingResult, Model model,
	...
	public String updateVehicleModel(@Valid @ModelAttribute("vehicleModel") VehicleModelForm vehicleModelForm, BindingResult bindingResult, Model model) {
